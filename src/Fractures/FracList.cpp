...
void FracList::_updateRepulsion(double x0,
                                ...
                                VectorDouble& denstab)
{
  Id idisc0 = (Id)((x0 - _xorigin) / _step);
                              ...
                              const NamingConvention& namconv)
{
  ...
  for (Id ifrac = 0; ifrac < getNFracs(); ifrac++)
  {
    ...
    double perm    = 0.;
    if (ifam < (Id)permtab.size()) perm = permtab[ifam];
    if (perm <= 0.) continue;
                                  ...
                                  bool verbose)
{
  ...
  for (Id iw = 0; iw < nw_xy; iw++)
  {
    ...
    Id ifrac    = (Id)WELLOUT(iw, 2) - 1;
    Id ip       = (Id)WELLOUT(iw, 3) - 1;
