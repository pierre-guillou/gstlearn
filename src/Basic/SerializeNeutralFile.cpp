...
bool SerializeNeutralFile::_fileOpenWrite(const ASerializable& parent,
...
bool SerializeNeutralFile::_fileOpenRead(const ASerializable& parent,
                                         const String& filename,
                                         std::ifstream& is,
                                         bool verbose)
{
...
bool SerializeNeutralFile::_commentWrite(std::ostream& os, const String& comment)
{
  if (os.good())
  {
    if (comment.empty())
...
bool SerializeNeutralFile::_tableWrite(std::ostream& os,
                                       const String& string,
                                       int ntab,
...
bool SerializeNeutralFile::_tableRead(std::istream& is,
                                      const String& string,
                                      int ntab,
                                      double* tab)
{
...
bool SerializeNeutralFile::_onlyBlanks(char* string)
{
