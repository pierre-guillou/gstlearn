...
{
  return SerializeNeutralFile::_recordWrite(os, title, val);
}
...
bool ASerializable::_recordWriteVec(std::ostream& os,
                                    ...
                                    const std::vector<T>& vec)
{
  return SerializeNeutralFile::_recordWriteVec(os, title, vec);
}

template<typename T>
bool ASerializable::_recordRead(std::istream& is, const String& title, T& val)
{
  return SerializeNeutralFile::_recordRead(is, title, val);
}
...
bool ASerializable::_recordReadVec(std::istream& is,
                                   ...
                                   int nvalues)
{
  return SerializeNeutralFile::_recordReadVec(is, title, vec, nvalues);
}
...
bool ASerializable::_recordReadVecInPlace(std::istream& is,
                                          ...
                                          int nvalues)
{
  return SerializeNeutralFile::_recordReadVecInPlace<T>(is, title, it, nvalues);
}
