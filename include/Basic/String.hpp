...
GSTLEARN_EXPORT Id gslFScanf(FILE *stream, const char *format, ...);
...
/*
 template<typename ... Args>
 Id gslSPrintf(String& dst, String fmt, Args... args )
 {
 Id size_s = std::snprintf( nullptr, 0, fmt.c_str(), args ... ) + 1; // Extra space for '\0'
